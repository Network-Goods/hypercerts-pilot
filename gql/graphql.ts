...
export type GetHypercertByIdQuery = { __typename?: 'Query', hypercert?: { __typename?: 'Hypercert', id: string, claimHash: any, totalUnits: any, minter: string, uri: string, contributors: Array<{ __typename?: 'Contributor', id: string }> } | null };
