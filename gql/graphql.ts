...
export type GetAllHypercertsQuery = { __typename?: 'Query', hypercerts: Array<{ __typename?: 'Hypercert', id: string, claimHash: any, minter: string, uri: string, fractions: Array<{ __typename?: 'HypercertFraction', id: string }>, contributors: Array<{ __typename?: 'Contributor', id: string }> }> };

export type GetAllHypercertsMintedByQueryVariables = Exact<{
  minter: Scalars['String'];
}>;


export type GetAllHypercertsMintedByQuery = { __typename?: 'Query', hypercerts: Array<{ __typename?: 'Hypercert', id: string, minter: string, lastUpdated: any, fractions: Array<{ __typename?: 'HypercertFraction', id: string, owner: { __typename?: 'Owner', id: string } }> }> };
...
export type GetHypercertMetadataQueryVariables = Exact<{
  hypercertId: Scalars['ID'];
}>;


export type GetHypercertMetadataQuery = { __typename?: 'Query', hypercert?: { __typename?: 'Hypercert', id: string, metadata: string } | null };
...
export const GetAllHypercertsMintedByDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetAllHypercertsMintedBy"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"minter"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hypercerts"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"minter"},"value":{"kind":"Variable","name":{"kind":"Name","value":"minter"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"minter"}},{"kind":"Field","name":{"kind":"Name","value":"lastUpdated"}},{"kind":"Field","name":{"kind":"Name","value":"fractions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"owner"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetAllHypercertsMintedByQuery, GetAllHypercertsMintedByQueryVariables>;
...
export const GetHypercertMetadataDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetHypercertMetadata"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"hypercertId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hypercert"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"hypercertId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"metadata"}}]}}]}}]} as unknown as DocumentNode<GetHypercertMetadataQuery, GetHypercertMetadataQueryVariables>;